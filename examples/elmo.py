...
from allennlp.nn.util import add_sentence_boundary_token_ids, remove_sentence_boundaries, get_device_of
...
class ELMoCharacterMapper:
    ...
    beginning_of_description_character = 256  # <begin sentence>
    beginning_of_context_character = 261  # <begin sentence>
    end_of_sentence_character = 257  # <end sentence>
    beginning_of_word_character = 258  # <begin word>
    end_of_word_character = 259  # <end word>
    padding_character = 260 # <padding>

    beginning_of_description_characters = _make_bos_eos(
            beginning_of_description_character,
            padding_character,
            beginning_of_word_character,
            end_of_word_character,
            max_word_length
    )
    beginning_of_context_characters = _make_bos_eos(
            beginning_of_context_character,
            padding_character,
            beginning_of_word_character,
            end_of_word_character,
            max_word_length
...
@TokenIndexer.register("new_elmo_characters")
