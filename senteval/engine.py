...
from senteval.preco import PreCoEval
...
from senteval.kore import KOREEval
from senteval.er import EREval
from senteval.fever import FeverEval
...
class SE(object):
    def __init__(self, params, batcher, prepare=None):
        ...
        self.list_tasks = ['CR', 'MR', 'MPQA', 'SUBJ', 'SST2', 'SST5', 'TREC', 'MRPC',
                           ...
                           'OddManOut', 'CoordinationInversion', 'PreCo', 'KORE', 'ER',
                           'Fever']
    ...
    def eval(self, name):
        ...
        if name == 'CR':
            ...
            self.evaluation = PreCoEval(tpath + '/downstream/PreCo', seed=self.params.seed)
        elif name == 'KORE':
            self.evaluation = KOREEval(tpath + '/downstream/KORE/', seed=self.params.seed)
        elif name == 'ER':
            self.evaluation = EREval(tpath + '/downstream/ER/', seed=self.params.seed)
        elif name == 'Fever':
            self.evaluation = FeverEval(tpath + '/downstream/fever/', seed=self.params.seed)
